...
class TestApp(unittest.TestCase):
    ...
    def test_2_get_user_products_valid_token(self):
        ...
        response = tester.ge('/api/v1/users/1/1', content_type='application/json', headers=headers)
    ...
    def test_3_get_user_products_invalid_token(self):
        ...
        response = tester.get('/api/va/users/1/products', content_type='applications/json', headers=headers)
        data=json.loads(response.text)
        print(f"get_user_products: {data}")
